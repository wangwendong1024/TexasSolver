@echo off
echo Fixing Visual Studio project issues...
...
echo Generating MOC files for Qt classes...
...
"%QTDIR%\bin\moc.exe" include\ui\rangeselectortablemodel.h -o debug\moc_rangeselectortabledelegate.cpp
...
echo Project fixed! You can now open TexasSolver_Simple.sln in Visual Studio.
pause
